...
document.querySelector('#add').onclick=()=>{const slide={id:crypto.randomUUID(),name:'New slide',headline:'NEW HEADLINE',subheading:'SUBHEADING',logo:'two-pennies',weight:1,enabled:true,starts:'',ends:'',eventIds:[],schedule:blankSchedule()};slides.unshift(slide);selectedId=slide.id;render();editor.scrollTo(0,0)};
